  ...
  useEffect(() => {
    const onKeyDown = (event) => {
      ...
      for (const binding of bindingsRef.current) {
        ...
        if (typeof binding.when === 'function' && !binding.when(event)) continue;
